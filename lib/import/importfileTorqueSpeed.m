function TorqueSpeed = importfileTorqueSpeed(filename, dataLines)
...
opts.VariableNames = ["Time", "Omega_meRef", "Omega_meActual", "TemRef", "TemActual", "Tload"];
...
% Import the data
TorqueSpeed = readtable(filename, opts);
